...
Route::middleware('auth.token')->post('/quests/{name}/complete', [QuestController::class, 'complete']);
...
Route::middleware('auth.token')->get('/quests/completed/count', [QuestController::class, 'completedCount']);
